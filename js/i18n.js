...
I18n.register('common', {
    ja: {
        ...
        researcherConfig: {
            ...
            preset: {
                heading: '設定プリセット', name: 'プリセット名', namePlaceholder: '例: Main study JA',
            ...
            link: {
                copy: '参加者リンクをコピー', copied: '設定を含む参加者リンクをコピーしました。',
                copyFailed: '参加者リンクをコピーできませんでした。',
            },
            validation: {
            ...
            cancel: 'キャンセル', clear: '研究者設定を解除', clearConfirm: '現在の研究者設定を解除しますか？', apply: '適用して参加者画面へ',
            applied: '研究者設定を適用しました。', cleared: '研究者設定を解除しました。参加者が開始画面で選択できます。',
        },
        consent: {
            heading: '実施の説明と同意',
        ...
        environment: {
            ...
            storageYes: 'セッション復元に対応しています', storageNo: 'セッション復元を利用できません', storageDetail: 'localStorage が無効な場合、途中復元はできません。Excel 保存は利用できます。',
    ...
    en: {
        ...
        researcherConfig: {
            ...
            subtitle: 'Configure the conditions applied to participants. Presets never contain participant information or results.',
            identity: {
            ...
            language: {
                heading: 'Session language', default: 'Default language', lock: 'Prevent participants from changing the language',
            ...
            link: {
                copy: 'Copy participant link', copied: 'Copied a participant link containing this configuration.',
                copyFailed: 'The participant link could not be copied.',
            },
            validation: {
            ...
            cancel: 'Cancel', clear: 'Clear researcher configuration', clearConfirm: 'Clear the current researcher configuration?', apply: 'Apply and open participant screen',
            applied: 'The researcher configuration has been applied.', cleared: 'The researcher configuration was cleared. Participants can choose on the start screen.',
        },
        consent: {
        ...
        environment: {
            ...
            storageYes: 'Session recovery is available', storageNo: 'Session recovery is unavailable', storageDetail: 'If localStorage is disabled, session recovery is unavailable. Excel export will still work.',
